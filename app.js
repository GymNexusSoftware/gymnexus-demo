...
class FitnessApp {
    constructor() {
        ...
        this.firebaseAppConfig = {
            ...
            measurementId: AppConfig.firebaseConfig.measurementId,
            serverKey: AppConfig.firebaseConfig.serverKey // ATENÇÃO: Está chave deve começar por AAAA...
        };
    ...
    async init() {
        ...
        this.dbRef.on('value', (snapshot) => {
            try {
                ...
                if (!this.state.admins.some(a => a.email === AppConfig.defaultAdminEmail)) {
...
Equipa `;
        ...
        const whatsappText = `*Bem-vindo a * 
...
Bons treinos!`;
    ...
    openTrainingEditor(clientId) {
        ...
        const draft = localStorage.getItem('_training_draft');
        if (draft) {
            ...
            if (draftData.clientId === clientId) {
                if (confirm('Detetamos um rascunho não guardado deste treino. Deseja recupera-lo?')) {
                    ...
                    localStorage.removeItem('_training_draft');
                }
            }
        }
    ...
    saveTrainingDraft() {
        ...
        localStorage.setItem('_training_draft', JSON.stringify(draftData));
    }
    ...
    downloadTrainingPDF(clientId) {
        ...
        let html = `
            <div style="text-align: center; margin-bottom: 20px; border-bottom: 2px solid #911B2B; padding-bottom: 10px;">
                <h1 style="color: #911B2B; margin: 0;"></h1>
    ...
    sendExternalNotification(clientId, topic, type) {
        ...
        const appUrl = "https://pro.web.app";
